...
// https://github.com/fbsobreira/gotron-sdk/blob/master/pkg/common/base58.go
...
func Decode(input string) ([]byte, error) {
	bs, err := base58.Decode(input, base58.BitcoinAlphabet)
...
func DecodeCheck(input string) ([]byte, error) {
	...
	if len(decodeCheck) < 4 {
		return nil, errors.New("b58 check error")
	}
