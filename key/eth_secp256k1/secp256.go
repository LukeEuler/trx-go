...
var (
	ErrInvalidMsgLen = func() error {
		return errors.New("invalid message length, need 32 bytes")
	}
	ErrInvalidSignatureLen = func() error {
		return errors.New("invalid signature length")
	}
	ErrInvalidRecoveryID = func() error {
		return errors.New("invalid signature recovery id")
	}
	ErrInvalidKey = func() error {
		return errors.New("invalid private key")
	}
	ErrInvalidPubkey = func() error {
		return errors.New("invalid public key")
	}
	ErrSignFailed = func() error {
		return errors.New("signing failed")
	}
	ErrRecoverFailed = func() error {
